...
#create_trainvaltest_split_Context()
"""
f=False
DATASET = 'Travel_STS'
DATASEED=1234
...
SPLITFROMFILE=False
VERBOSE=True
datasplit_path = 'D:/A PHD/Codes Trials/Context/gc-mc- Auto encoder Rianne/gc-mc-master/gcmc/data/Travel_STS/withfeatures.pickle'
